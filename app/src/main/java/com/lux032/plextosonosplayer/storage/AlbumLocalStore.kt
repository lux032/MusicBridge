package com.lux032.plextosonosplayer.storage
...
private class AlbumDatabaseHelper(context: Context) :
    ...
    override fun onCreate(db: SQLiteDatabase) {
        ...
        db.execSQL(
            "CREATE INDEX index_albums_title ON $TABLE_ALBUMS($COLUMN_TITLE COLLATE NOCASE)"
        )
        db.execSQL(
            "CREATE INDEX index_albums_artist_name ON $TABLE_ALBUMS($COLUMN_ARTIST_NAME COLLATE NOCASE)"
        )
    }
